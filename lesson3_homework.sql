...
CREATE TABLE content (
    ...
    message varchar(300) COMMENT "Текствое сообщение",
	media_id INT COMMENT "Идентификатор медиафайла ",
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT "Время создания строки",  
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT "Время обновления строки" 
);

-- Таблица лайков под постами
CREATE TABLE content_likes (
	user_id INT NOT NULL COMMENT "Идентификатор пользователя, поставившего лайк",
    post_id INT NOT NULL COMMENT "Идентификатор поста, получивший лайк",
	PRIMARY KEY (user_id, post_id) 
);

-- Таблица лайков под пользвателями
CREATE TABLE user_likes (
	user_id INT NOT NULL COMMENT "Идентификатор пользователя, поставившего лайк",
    user_id_liked INT NOT NULL COMMENT "Идентификатор пользователя, получившего лайк",
